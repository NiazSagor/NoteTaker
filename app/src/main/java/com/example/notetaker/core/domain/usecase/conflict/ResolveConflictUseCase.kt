...
) : UseCase<com.example.notetaker.core.domain.usecase.conflict.ResolveConflictParams, Unit>(dispatcher) {
    override suspend fun execute(parameters: com.example.notetaker.core.domain.usecase.conflict.ResolveConflictParams) {
