...
) : UseCase<com.example.notetaker.core.domain.usecase.image.AddStandaloneImageParams, Unit>(dispatcher) {
    override suspend fun execute(parameters: com.example.notetaker.core.domain.usecase.image.AddStandaloneImageParams) {
